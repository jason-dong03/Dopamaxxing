...
type TeamTemplate = Omit<
    BattleCard,
    'statusEffect' | 'statusTurns' | 'lastAttackDamage'
>
...
export const N_TEAM: TeamTemplate[] = [
    {
        ...
        pokemon_type: 'dark',
        hp: 0,
        maxHp: 0, // overridden by rollLevelHp at battle start
        speed: 105,
        evasion: 0.04,
        accuracy: 0.9,
        ...
        attacks: [
            {
                ...
                damage: 0,
                attackType: 'dark',
                effect: "Mirrors the opponent's last attack.",
                copyLastAttack: true,
                maxPp: 15,
            },
            {
                ...
                damage: 85,
                attackType: 'dark',
                effect: 'A powerful dark pulse. May confuse.',
                statusInflict: 'confusion',
                maxPp: 10,
            },
            {
                name: 'Nasty Plot',
                ...
                selfBoosts: [{ stat: 'attack', stages: 2 }],
                maxPp: 20,
            },
            {
                name: 'Shadow Ball',
                damage: 80,
                attackType: 'ghost',
                effect: 'A shadowy blob. May lower DEF.',
                enemyDrops: [{ stat: 'defense', stages: -1 }],
                maxPp: 15,
            },
        ],
    },
    {
        ...
        accuracy: 0.92,
        image_url:
            'https://play.pokemonshowdown.com/sprites/ani/carracosta.gif',
        attacks: [
            {
                name: 'Brine',
                damage: 65,
                attackType: 'water',
                effect: 'Power doubles when target is below half HP.',
                damageBonus: 65,
                bonusCondition: 'hp_below_max',
                maxPp: 10,
            },
            {
                name: 'Surf',
                damage: 95,
                attackType: 'water',
                effect: 'A powerful wave crashes down.',
                maxPp: 15,
            },
            {
                name: 'Shell Smash',
                damage: 0,
                attackType: 'normal',
                effect: 'Smashes its shell to sharply raise ATK and SPD.',
                selfBoosts: [
            ...
            },
            {
                ...
                damage: 40,
                attackType: 'water',
                effect: 'A surging strike that always goes first.',
                priority: 1,
                maxPp: 20,
            },
        ],
    },
    {
        ...
        attacks: [
            ...
            },
            {
                ...
                damage: 110,
                attackType: 'flying',
                effect: 'Swift aerial strike. Archeops grows faster.',
                speedBoost: 12,
                maxPp: 15,
            },
            {
        ...
        attacks: [
            {
                ...
                damage: 120,
                attackType: 'dragon',
                effect: '+15 per damage counter on Reshiram.',
                damageBonus: 15,
                bonusCondition: 'self_damaged',
                maxPp: 10,
            },
            {
                name: 'Blue Flare',
                damage: 130,
                attackType: 'fire',
                effect: 'Pillar of sacred fire. Burns. Reshiram takes 40 recoil.',
                statusInflict: 'burn',
                selfDamage: 40,
                maxPp: 5,
            },
            {
                ...
                damage: 60,
                attackType: 'dragon',
                effect: 'Exhales a powerful breath. May paralyze.',
                statusInflict: 'paralysis',
                maxPp: 20,
            },
            {
                name: 'Roost',
        ...
        attacks: [
            {
                ...
                damage: 120,
                attackType: 'dragon',
                effect: '+15 per damage counter on Zekrom.',
                damageBonus: 15,
                bonusCondition: 'self_damaged',
                maxPp: 10,
            },
            {
                ...
                damage: 130,
                attackType: 'electric',
                effect: 'Devastating thunder. Paralyzes. Zekrom takes 40 recoil.',
                statusInflict: 'paralysis',
                selfDamage: 40,
                maxPp: 5,
            },
            ...
            },
            {
                ...
                damage: 0,
                attackType: 'dark',
                effect: 'Sharpens claws to raise ATK.',
                selfBoosts: [{ stat: 'attack', stages: 1 }],
                maxPp: 15,
            },
        ],
    },
...
export const N_EXTRAS_POOL: TeamTemplate[] = [
    ...
    N_TEAM.find((t) => t.id === 'n-archeops')!,
    {
        ...
        accuracy: 0.9,
        image_url:
            'https://play.pokemonshowdown.com/sprites/ani/krookodile.gif',
        attacks: [
            {
                name: 'Crunch',
                damage: 80,
                attackType: 'dark',
                effect: 'A vicious bite. May lower DEF.',
                enemyDrops: [{ stat: 'defense', stages: -1 }],
                maxPp: 15,
            },
            {
            ...
            },
            {
                ...
                damage: 0,
                attackType: 'normal',
                effect: 'A terrifying face lowers enemy SPD sharply.',
    ...
    },
    {
        ...
        accuracy: 0.91,
        image_url:
            'https://play.pokemonshowdown.com/sprites/ani/seismitoad.gif',
        attacks: [
            {
                name: 'Muddy Water',
                damage: 90,
                attackType: 'water',
                effect: 'Murky water lowers accuracy.',
                statusInflict: 'confusion',
                maxPp: 10,
            },
            {
                ...
                damage: 75,
                attackType: 'fighting',
                effect: "Saps the opponent's strength.",
                maxPp: 10,
            },
            {
                name: 'Sludge Bomb',
                damage: 90,
                attackType: 'poison',
                effect: 'Hurls sludge. May poison.',
                statusInflict: 'poison',
                maxPp: 10,
            },
            {
                name: 'Toxic',
    ...
    },
    {
        ...
        accuracy: 0.9,
        image_url:
            'https://play.pokemonshowdown.com/sprites/ani/darmanitan.gif',
        attacks: [
            {
                name: 'Flare Blitz',
                damage: 120,
                attackType: 'fire',
                effect: 'Reckless flame charge. Burns. Takes 40 recoil. Darmanitan accelerates.',
                selfDamage: 40,
                statusInflict: 'burn',
                speedBoost: 12,
                maxPp: 15,
            ...
            },
            {
                ...
                damage: 75,
                attackType: 'fire',
                effect: 'A flaming punch. May burn.',
                statusInflict: 'burn',
                maxPp: 15,
            },
            {
                ...
                damage: 0,
                attackType: 'fighting',
                effect: 'Bulks up to raise ATK and DEF.',
                selfBoosts: [
        ...
        attacks: [
            {
                ...
                damage: 90,
                attackType: 'psychic',
                effect: 'A telekinetic force. May confuse.',
                statusInflict: 'confusion',
                maxPp: 10,
            },
            {
                ...
                damage: 75,
                attackType: 'flying',
                effect: 'Slicing air blades. May paralyze.',
                statusInflict: 'paralysis',
                maxPp: 15,
            },
            {
                ...
                damage: 0,
                attackType: 'psychic',
                effect: 'Draws in cosmic energy to raise DEF.',
                selfBoosts: [{ stat: 'defense', stages: 1 }],
                maxPp: 20,
            },
            {
                name: 'Roost',
        ...
        attacks: [
            {
                ...
                damage: 130,
                attackType: 'fighting',
                effect: 'A soaring kick. User takes recoil on miss.',
                selfDamage: 30,
                maxPp: 10,
            },
            {
                ...
                damage: 80,
                attackType: 'dark',
                effect: 'A pulse of dark energy. May confuse.',
                statusInflict: 'confusion',
                maxPp: 15,
            },
            {
            ...
            },
            {
                ...
                damage: 0,
                attackType: 'dragon',
                effect: 'A mystic dance that raises ATK and SPD.',
                selfBoosts: [
                    { stat: 'attack', stages: 1 },
                    { stat: 'speed', stages: 1 },
                ],
        ...
        attacks: [
            {
                ...
                damage: 80,
                attackType: 'dark',
                effect: 'Strikes before the opponent can act. Liepard gets in the zone.',
                priority: 1,
                speedBoost: 15,
                maxPp: 5,
            },
            {
                ...
                damage: 90,
                attackType: 'fairy',
                effect: 'A rough, unpredictable assault. May cause confusion.',
                statusInflict: 'confusion',
                maxPp: 10,
            },
            {
                ...
                damage: 0,
                attackType: 'electric',
                effect: 'Paralyzes with an electric charge.',
                statusInflict: 'paralysis',
                alwaysInflict: true,
                maxPp: 20,
            },
            {
                ...
                damage: 0,
                attackType: 'fairy',
                effect: 'Charms the foe to sharply lower its ATK.',
                enemyDrops: [{ stat: 'attack', stages: -2 }],
                maxPp: 20,
            },
        ],
    },
...
/** Builds N's battle team (5 pokemon):
 *  - Zoroark always included, 85% chance to be the lead (index 0)
 *  - At least one of Reshiram / Zekrom always included
 *  - Remaining slots filled randomly from the extras pool */
export function buildNTeam(): BattleCard[] {
    const zoroark = N_TEAM.find((t) => t.id === 'n-zoroark')!
    const reshiram = N_TEAM.find((t) => t.id === 'n-reshiram')!
    const zekrom = N_TEAM.find((t) => t.id === 'n-zekrom')!

    // Pick 1 or 2 legendaries — always at least one
    const bothLegends = Math.random() < 0.4
    const legendaries = bothLegends
        ? [reshiram, zekrom]
        : Math.random() < 0.5
          ? [reshiram]
          : [zekrom]

    // Fill remaining slots from extras pool (exclude already-picked legendaries)
    const legendaryIds = new Set(legendaries.map((t) => t.id))
    const pool = N_EXTRAS_POOL.filter((t) => !legendaryIds.has(t.id))
    for (let i = pool.length - 1; i > 0; i--) {
        const j = Math.floor(Math.random() * (i + 1))
        ;[pool[i], pool[j]] = [pool[j], pool[i]]
    }
    const fillers = pool.slice(0, 5 - 1 - legendaries.length)

    // Shuffle the non-Zoroark members
    const rest = [...legendaries, ...fillers]
    for (let i = rest.length - 1; i > 0; i--) {
        const j = Math.floor(Math.random() * (i + 1))
        ;[rest[i], rest[j]] = [rest[j], rest[i]]
    }

    // 85% chance Zoroark leads; 15% chance it's placed randomly in the lineup
    let team: TeamTemplate[]
    if (Math.random() < 0.85) {
        team = [zoroark, ...rest]
    } else {
        const pos = 1 + Math.floor(Math.random() * rest.length)
        rest.splice(pos, 0, zoroark)
        team = rest
    }
...
export const GHETSIS_TEAM: TeamTemplate[] = [
    {
        ...
        accuracy: 0.9,
        image_url:
            'https://play.pokemonshowdown.com/sprites/ani/cofagrigus.gif',
        attacks: [
            {
                name: 'Shadow Ball',
                damage: 80,
                attackType: 'ghost',
                effect: 'A void of darkness. May lower DEF.',
                enemyDrops: [{ stat: 'defense', stages: -1 }],
            },
            {
                name: 'Will-O-Wisp',
            ...
            },
            {
                ...
                damage: 65,
                attackType: 'ghost',
                effect: 'Ghostly hex. Hits harder if foe has a status.',
            },
        ],
    },
    {
        ...
        attacks: [
            {
                ...
                damage: 90,
                attackType: 'water',
                effect: 'Murky wave lowers accuracy.',
                statusInflict: 'confusion',
            },
            {
                name: 'Drain Punch',
                damage: 100,
                attackType: 'fighting',
                effect: "Drains opponent's strength.",
            },
            {
                name: 'Sludge Wave',
                damage: 95,
                attackType: 'poison',
                effect: 'A wave of sludge. May poison.',
                statusInflict: 'poison',
            },
            {
                name: 'Toxic',
    ...
    },
    {
        ...
        evasion: 0.04,
        accuracy: 0.92,
        image_url: 'https://play.pokemonshowdown.com/sprites/ani/bisharp.gif',
        attacks: [
            {
                name: 'Iron Head',
                damage: 90,
    ...
    },
    {
        ...
        accuracy: 0.9,
        image_url:
            'https://play.pokemonshowdown.com/sprites/ani/eelektross.gif',
        attacks: [
            {
                name: 'Thunderbolt',
                damage: 115,
            ...
            },
            {
                ...
                damage: 120,
                attackType: 'electric',
                effect: 'Charges with power. Takes 30 recoil.',
                selfDamage: 30,
                statusInflict: 'paralysis',
            },
            {
                ...
                damage: 40,
                attackType: 'poison',
                effect: 'Corrodes the foe, sharply lowering DEF.',
                enemyDrops: [{ stat: 'defense', stages: -2 }],
            },
        ],
    },
    {
        ...
        evasion: 0.05,
        accuracy: 0.92,
        image_url: 'https://play.pokemonshowdown.com/sprites/ani/hydreigon.gif',
        attacks: [
            {
                name: 'Dragon Rush',
                damage: 130,
                attackType: 'dragon',
                effect: 'A devastating charge.',
                statusInflict: 'confusion',
            },
            {
                name: 'Dark Pulse',
                damage: 150,
                attackType: 'dark',
                effect: "Ghetsis's ace unleashes darkness.",
                statusInflict: 'confusion',
            },
            {
                name: 'Fire Blast',
                damage: 110,
                attackType: 'fire',
                effect: 'A searing blast. May burn.',
                statusInflict: 'burn',
            },
            {
                name: 'Hyper Voice',
...
export const IRIS_TEAM: TeamTemplate[] = [
    {
        ...
        evasion: 0.06,
        accuracy: 0.88,
        image_url: 'https://play.pokemonshowdown.com/sprites/ani/druddigon.gif',
        attacks: [
            {
                name: 'Dragon Claw',
                damage: 90,
                attackType: 'dragon',
                effect: 'Sharp dragon claws.',
            },
            {
                name: 'Sucker Punch',
                damage: 85,
            ...
            },
            {
                ...
                damage: 120,
                attackType: 'dragon',
                effect: 'A raging draconic assault.',
            },
            {
                name: 'Scary Face',
                damage: 0,
                attackType: 'normal',
                effect: 'Lowers enemy SPD sharply.',
                enemyDrops: [{ stat: 'speed', stages: -2 }],
            },
        ],
    },
    {
        ...
        evasion: 0.04,
        accuracy: 0.93,
        image_url: 'https://play.pokemonshowdown.com/sprites/ani/lapras.gif',
        attacks: [
            {
                name: 'Ice Beam',
                damage: 105,
            ...
            },
            {
                ...
                damage: 110,
                attackType: 'water',
                effect: 'A powerful wave.',
            },
            {
                name: 'Thunder Wave',
                damage: 0,
                attackType: 'electric',
                effect: 'Paralyzes with electricity.',
                statusInflict: 'paralysis',
                alwaysInflict: true,
            },
            {
                ...
                damage: 110,
                attackType: 'ice',
                effect: 'A freezing blizzard. May paralyze.',
                statusInflict: 'paralysis',
            },
        ],
    },
    {
        ...
        evasion: 0.04,
        accuracy: 0.92,
        image_url: 'https://play.pokemonshowdown.com/sprites/ani/aggron.gif',
        attacks: [
            {
                name: 'Iron Tail',
                damage: 115,
            ...
            },
            {
                ...
                damage: 0,
                attackType: 'steel',
                effect: 'Hardens body to sharply raise DEF.',
                selfBoosts: [{ stat: 'defense', stages: 2 }],
            },
            {
                name: 'Heavy Slam',
                damage: 100,
                attackType: 'steel',
                effect: 'Crushes foe with massive weight.',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        evasion: 0.04,
        accuracy: 0.92,
        image_url: 'https://play.pokemonshowdown.com/sprites/ani/haxorus.gif',
        attacks: [
            {
                name: 'Dragon Dance',
                damage: 0,
                attackType: 'dragon',
                effect: "Iris's ace raises ATK and SPD.",
                selfBoosts: [
                    { stat: 'attack', stages: 1 },
                    { stat: 'speed', stages: 1 },
                ],
            },
            {
                ...
                damage: 160,
                attackType: 'dragon',
                effect: 'Unstoppable draconic rage.',
            },
            {
                name: 'Earthquake',
                damage: 100,
...
export const COLRESS_TEAM: TeamTemplate[] = [
    {
        ...
        evasion: 0.04,
        accuracy: 0.9,
        image_url: 'https://play.pokemonshowdown.com/sprites/ani/klinklang.gif',
        attacks: [
            {
                name: 'Gear Grind',
                damage: 80,
                attackType: 'steel',
                effect: 'Metal gears tear into the foe.',
            },
            {
                name: 'Flash Cannon',
                damage: 100,
                attackType: 'steel',
                effect: 'Steel energy burst.',
            },
            {
                name: 'Shift Gear',
                damage: 0,
                attackType: 'steel',
                effect: 'Cranks its gears to raise ATK and sharply raise SPD.',
                selfBoosts: [
                    { stat: 'attack', stages: 1 },
                    { stat: 'speed', stages: 2 },
                ],
            },
            {
                ...
                damage: 70,
                attackType: 'electric',
                effect: 'Strikes with electricity.',
            },
        ],
    },
    {
        ...
        evasion: 0.04,
        accuracy: 0.92,
        image_url: 'https://play.pokemonshowdown.com/sprites/ani/magnezone.gif',
        attacks: [
            {
                name: 'Thunderbolt',
                damage: 115,
            ...
            },
            {
                ...
                damage: 65,
                attackType: 'steel',
                effect: 'A steel mirror shot. May lower ATK.',
                enemyDrops: [{ stat: 'attack', stages: -1 }],
            },
        ],
    },
    {
        ...
        evasion: 0.04,
        accuracy: 0.94,
        image_url: 'https://play.pokemonshowdown.com/sprites/ani/beheeyem.gif',
        attacks: [
            {
                name: 'Psychic',
                damage: 120,
                attackType: 'psychic',
                effect: 'A crushing psychic force.',
                statusInflict: 'confusion',
            },
            {
                name: 'Thunder Wave',
    ...
    },
    {
        ...
        accuracy: 0.9,
        image_url:
            'https://play.pokemonshowdown.com/sprites/ani/electivire.gif',
        attacks: [
            {
                name: 'Wild Charge',
                damage: 120,
            ...
            },
            {
                ...
                damage: 110,
                attackType: 'fighting',
                effect: 'A precise cross blow.',
            },
            {
                name: 'Thunder Punch',
                damage: 75,
                attackType: 'electric',
                effect: 'An electrified punch. May paralyze.',
                statusInflict: 'paralysis',
            },
            {
                name: 'Earthquake',
    ...
    },
    {
        ...
        evasion: 0.04,
        accuracy: 0.94,
        image_url: 'https://play.pokemonshowdown.com/sprites/ani/metagross.gif',
        attacks: [
            {
                name: 'Meteor Mash',
                damage: 135,
                attackType: 'steel',
                effect: 'A steel meteor strike.',
                speedBoost: 10,
            },
            {
                name: 'Psychic',
                damage: 140,
                attackType: 'psychic',
                effect: "Colress's ace unleashes psychic annihilation.",
            },
            {
                name: 'Bullet Punch',
                damage: 40,
                attackType: 'steel',
                effect: 'A steel fist that always goes first.',
                priority: 1,
            },
            {
                name: 'Earthquake',
...
export function getTrainerPool(
    trainerId: TrainerId | string,
    userLevel?: number,
): { name: string; image_url: string; pokemon_type: string; level: number }[] {
    ...
    return pool.map((t, i) => ({
        ...
        level:
            userLevel != null ? Math.max(1, userLevel + (i % 5) - 2) : t.level,
    }))
}
...
export type MoveExtra = Partial<
    Omit<Attack, 'name' | 'damage' | 'attackType' | 'effect' | 'maxPp'>
>
...
export function getUserCardStats(rarity: string): {
    speed: number
    evasion: number
    accuracy: number
} {
    ...
    const attacks: Attack[] = [
        {
            name: 'Quick Strike',
            damage: base,
            effect: 'A swift, reliable attack.',
            maxPp: 35,
        },
        {
            name: 'Power Slam',
            damage: power,
            effect: 'A heavy blow. May paralyze.',
            statusInflict: 'paralysis',
            maxPp: 20,
        },
    ]
...
export function mapTcgdexAttacks(
    ...
    const m = RARITY_MULT[rarity] ?? 1.0
    const fallback = Math.floor(Math.max(hp, 30) * 0.1 * m) // small tap for utility moves
...
export function calcDamage(
    ...
    if (attack.damageBonus && attack.bonusCondition) {
        ...
        if (
            attack.bonusCondition === 'self_damaged' &&
    ...
    dmg = Math.round(
        (dmg * Math.max(1, attacker.level)) / Math.max(1, defender.level),
    )
...
export function tickStatus(card: BattleCard): {
    ...
    if (card.statusEffect === 'confusion' && skip) {
        ...
        confusionSelfHit = Math.floor(
            card.maxHp * (0.05 + Math.random() * 0.05),
        )
    }
...
export function decrementStatus(card: BattleCard): BattleCard {
    ...
    return {
        ...
        statusEffect:
            next === 0 &&
            card.statusEffect !== 'burn' &&
            card.statusEffect !== 'poison' &&
            card.statusEffect !== 'paralysis'
                ? 'none'
                : card.statusEffect,
    }
}
